...
public class TransferPhonePIN extends JFrame {
	...
	public static void main(String usrsend, String usrget, String money) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TransferPhonePIN frame = new TransferPhonePIN();
					...
					JLabel Name = new JLabel("Phone Number " + usrget);
					...
					OK.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							if(getPIN.compareTo(correct)==0) {
								...
								mysql.PhoneCharge(usrsend, usrget, amount);

								frame.dispose();
								frame.callPINyes(usrsend,usrget,"PHONE NUMBER", mysql.getBalance(usrsend));
							}
							else {
					...
					Cancel.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							frame.dispose();
							frame.callPhone(usrsend, mysql.getBalance(usrsend));
						}
					});
