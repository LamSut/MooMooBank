...
public class TransferExternalNext extends JFrame {
	 ...
	 */
	public static void main(String usrsend, long bal, String bankget) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TransferExternalNext frame = new TransferExternalNext();
					...
					Receiver.setBounds(160, 220, 180, 20);
					...
					Amount.setBounds(160, 264, 180, 20);
					...
					OK.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							String usrget = mysql.exID(usrgettemp,bankget);
							if(usrget.compareTo("1")==0 || usrget.compareTo(usrsend)==0) {
								...
								if(amount>bal) {
									...
									frame.callPIN(usrsend, usrget, bankget, money);
									frame.dispose();
								}
							}
						}
	...
	public void callPIN(String usrsend, String usrget, String bankget, String money) {
		TransferExternalPIN.main(usrsend, usrget, bankget, money);
	}
	
	public void callPrev(String usrsend, long bal) {
		TransferExternal.main(usrsend,bal);
	}
	/**
	 * Create the frame.
	 */
	public TransferExternalNext() {
		...
		ReceiverLabel.setBounds(80, 208, 91, 45);
		...
		AmountLabel.setBounds(80, 252, 91, 45);
